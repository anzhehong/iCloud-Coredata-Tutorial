...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let documentsDirectory = NSFileManager.defaultManager().URLsForDirectory(NSSearchPathDirectory.DocumentDirectory,
        ...
        let storeOptions = [NSPersistentStoreUbiquitousContentNameKey: "CloudStore"]
